...
namespace AmplifyShaderEditor
{
	...
	[Serializable]
    [NodeAttributes("Note Node", "Debug", "This node lets you write a block of text as a note", null, UnityEngine.KeyCode.None, true)]
	public sealed class NoteNode :CustomNode, ISerializationCallbackReceiver {

		private const string InfoText = "It's basically a sticky note";

		private const string CommentaryTitle = "Note";
		...
		private const float COMMENTARY_BOX_HEIGHT = 300;
		...
		private string m_focusName = "NoteNode";
		...
		public override void OnNodeLayout( DrawInfo drawInfo )
		{
			...
			m_commentArea.height = m_globalPosition.height * drawInfo.InvertedZoom;
		...
		public override void OnNodeRepaint( DrawInfo drawInfo )
		{
			...
			{
                GUIStyle s = UIUtils.CommentaryTitle;
                s.wordWrap = true;
				GUI.Label( m_commentArea, m_commentText, s);
			}
